      ...
      <section className="max-w-2xl mx-auto py-20 px-6">
        ...
        {submitted ? (
          <div className="bg-brand-mint/20 border border-brand-mint rounded-2xl p-8 text-center">
            ...
            <p className="text-brand-sage">We'll get back to you soon with lots of joy.</p>
          </div>
        ) : (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form onSubmit={handleSubmit}>
              ...
              <button 
                type="submit"
                className="w-full bg-brand-coral text-white py-4 rounded-full font-bold text-lg hover:bg-brand-sage transition-all shadow-lg"
              >
                Send Message 💝
              </button>
            </form>
